...
import { UserloginUser } from "../../redux/actions/authActions";
function Login({UserloginUser , auth:{isAuthenticated}}) {
    const history = useHistory();
    const { register, handleSubmit, watch, errors } = useForm();
    if(isAuthenticated){
        history.push("/")
    }
  const onSubmit = data => UserloginUser(data);
...
Login.propTypes = {
    UserloginUser: PropTypes.func.isRequired,
